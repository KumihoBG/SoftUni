...
namespace _03.MultidimensionalArrays
{
    internal class MultidimensionalArrays
    {
        private static void Main()
        {
			...
			// стандартно принтиране на матрица
			...
			// пълнене на матрица от чарове - задача TextGravity
		...
		// пълнене на матрица, докато стигне до END
		...
		// принтиране на матрица с метода SecurityElement.Escape
